...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} pranešimas nakčiai",
  "session.overnightDock.summary.few": "{{count}} pranešimai nakčiai",
  "session.overnightDock.summary.many": "{{count}} pranešimo nakčiai",
  "session.overnightDock.summary.other": "{{count}} pranešimai nakčiai",
  "session.overnightDock.sendNow": "Siųsti dabar",
  "session.overnightDock.moveToQueue": "Perkelti į eilę",
  "session.overnightDock.collapse": "Sutraukti naktinius pranešimus",
  "session.overnightDock.expand": "Išplėsti naktinius pranešimus",
  "session.composer.sendOvernight": "Siųsti į naktinę eilę",
