export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} missatge nocturn",
  "session.overnightDock.summary.many": "{{count}} missatges nocturns",
  "session.overnightDock.summary.other": "{{count}} missatges nocturns",
  "session.overnightDock.sendNow": "Envia ara",
  "session.overnightDock.moveToQueue": "Mou a la cua",
  "session.overnightDock.collapse": "Replega els missatges nocturns",
  "session.overnightDock.expand": "Amplia els missatges nocturns",
  "session.composer.sendOvernight": "Envia a la cua nocturna",
