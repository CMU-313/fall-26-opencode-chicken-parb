...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} overnight message",
  "session.overnightDock.summary.other": "{{count}} overnight messages",
  "session.overnightDock.sendNow": "Send now",
  "session.overnightDock.moveToQueue": "Move to queue",
  "session.overnightDock.collapse": "Collapse overnight messages",
  "session.overnightDock.expand": "Expand overnight messages",
  "session.composer.sendOvernight": "Send to overnight queue",
