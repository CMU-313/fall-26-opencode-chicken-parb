export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} mesej semalaman",
  "session.overnightDock.summary.other": "{{count}} mesej semalaman",
  "session.overnightDock.sendNow": "Hantar sekarang",
  "session.overnightDock.moveToQueue": "Pindahkan ke giliran",
  "session.overnightDock.collapse": "Runtuhkan mesej semalaman",
  "session.overnightDock.expand": "Kembangkan mesej semalaman",
  "session.composer.sendOvernight": "Hantar ke giliran semalaman",
