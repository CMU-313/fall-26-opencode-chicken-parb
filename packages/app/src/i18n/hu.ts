...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} éjszakai üzenet",
  "session.overnightDock.summary.other": "{{count}} éjszakai üzenet",
  "session.overnightDock.sendNow": "Küldje el most",
  "session.overnightDock.moveToQueue": "Áthelyezés a várólistára",
  "session.overnightDock.collapse": "Éjszakai üzenetek összecsukása",
  "session.overnightDock.expand": "Éjszakai üzenetek kibontása",
  "session.composer.sendOvernight": "Küldés az éjszakai várólistára",
