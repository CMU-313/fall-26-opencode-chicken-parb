export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} náttarboð",
  "session.overnightDock.summary.other": "{{count}} náttarboð",
  "session.overnightDock.sendNow": "Send nú",
  "session.overnightDock.moveToQueue": "Flyt til bíðirøð",
  "session.overnightDock.collapse": "Samla náttarboð",
  "session.overnightDock.expand": "Víðka náttarboð",
  "session.composer.sendOvernight": "Send til náttarbíðirøð",
