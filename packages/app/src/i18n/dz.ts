export const dict: Record<string, string> = {
  ...
  "session.overnightDock.summary.one": "{{count}} མཚན་མོའི་འཕྲིན་འཕྲིན།",
  "session.overnightDock.summary.other": "{{count}} མཚན་མོའི་འཕྲིན་འཕྲིན།",
  "session.overnightDock.sendNow": "ད་ལྟོ་གཏང་།",
  "session.overnightDock.moveToQueue": "གྲལ་ཐིག་ནང་སྤོ།",
  "session.overnightDock.collapse": "མཚན་མོའི་འཕྲིན་དོན་ཚུ་མར་བསྡམས།",
  "session.overnightDock.expand": "མཚན་མོའི་འཕྲིན་དོན་ཚུ་རྒྱ་བསྐྱེད་འབད།",
  "session.composer.sendOvernight": "མཚན་མོའི་གྲལ་ཐིག་ནང་གཏང་།",
