export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} nattligt meddelande",
  "session.overnightDock.summary.other": "{{count}} nattliga meddelanden",
  "session.overnightDock.sendNow": "Skicka nu",
  "session.overnightDock.moveToQueue": "Flytta till kö",
  "session.overnightDock.collapse": "Fäll ihop nattliga meddelanden",
  "session.overnightDock.expand": "Fäll ut nattliga meddelanden",
  "session.composer.sendOvernight": "Skicka till nattkön",
