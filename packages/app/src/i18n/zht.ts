...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} 則夜間訊息",
  "session.overnightDock.summary.other": "{{count}} 則夜間訊息",
  "session.overnightDock.sendNow": "立即傳送",
  "session.overnightDock.moveToQueue": "移至佇列",
  "session.overnightDock.collapse": "收合夜間訊息",
  "session.overnightDock.expand": "展開夜間訊息",
  "session.composer.sendOvernight": "傳送到夜間佇列",
