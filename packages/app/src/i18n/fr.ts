export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} message de nuit",
  "session.overnightDock.summary.many": "{{count}} de messages de nuit",
  "session.overnightDock.summary.other": "{{count}} messages de nuit",
  "session.overnightDock.sendNow": "Envoyer maintenant",
  "session.overnightDock.moveToQueue": "Déplacer vers la file d'attente",
  "session.overnightDock.collapse": "Réduire les messages de nuit",
  "session.overnightDock.expand": "Développer les messages de nuit",
  "session.composer.sendOvernight": "Envoyer vers la file de nuit",
