export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} tungi xabar",
  "session.overnightDock.summary.other": "{{count}} tungi xabarlar",
  "session.overnightDock.sendNow": "Hozir yuboring",
  "session.overnightDock.moveToQueue": "Navbatga ko'chirish",
  "session.overnightDock.collapse": "Tungi xabarlarni yig'ish",
  "session.overnightDock.expand": "Tungi xabarlarni yoyish",
  "session.composer.sendOvernight": "Tungi navbatga yuborish",
