export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} ღამის შეტყობინება",
  "session.overnightDock.summary.other": "{{count}} ღამის შეტყობინება",
  "session.overnightDock.sendNow": "გაგზავნა ახლა",
  "session.overnightDock.moveToQueue": "რიგში გადატანა",
  "session.overnightDock.collapse": "ღამის შეტყობინებების ჩაკეცვა",
  "session.overnightDock.expand": "ღამის შეტყობინებების გაფართოება",
  "session.composer.sendOvernight": "ღამის რიგში გაგზავნა",
