...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} næturskilaboð",
  "session.overnightDock.summary.other": "{{count}} næturskilaboð",
  "session.overnightDock.sendNow": "Sendu núna",
  "session.overnightDock.moveToQueue": "Færa í biðröð",
  "session.overnightDock.collapse": "Draga saman næturskilaboð",
  "session.overnightDock.expand": "Stækka næturskilaboð",
  "session.composer.sendOvernight": "Senda í næturbiðröð",
