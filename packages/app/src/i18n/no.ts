...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} nattmelding",
  "session.overnightDock.summary.other": "{{count}} nattmeldinger",
  "session.overnightDock.sendNow": "Send nå",
  "session.overnightDock.moveToQueue": "Flytt til kø",
  "session.overnightDock.collapse": "Skjul nattmeldinger",
  "session.overnightDock.expand": "Utvid nattmeldinger",
  "session.composer.sendOvernight": "Send til nattekøen",
