export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} zpráva na noc",
  "session.overnightDock.summary.few": "{{count}} zprávy na noc",
  "session.overnightDock.summary.many": "{{count}} zprávy na noc",
  "session.overnightDock.summary.other": "{{count}} zpráv na noc",
  "session.overnightDock.sendNow": "Poslat nyní",
  "session.overnightDock.moveToQueue": "Přesunout do fronty",
  "session.overnightDock.collapse": "Sbalit zprávy na noc",
  "session.overnightDock.expand": "Rozbalit zprávy na noc",
  "session.composer.sendOvernight": "Odeslat do noční fronty",
