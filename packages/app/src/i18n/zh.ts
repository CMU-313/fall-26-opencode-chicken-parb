...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} 条夜间消息",
  "session.overnightDock.summary.other": "{{count}} 条夜间消息",
  "session.overnightDock.sendNow": "立即发送",
  "session.overnightDock.moveToQueue": "移至队列",
  "session.overnightDock.collapse": "折叠夜间消息",
  "session.overnightDock.expand": "展开夜间消息",
  "session.composer.sendOvernight": "发送到夜间队列",
