export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} паёми шабона",
  "session.overnightDock.summary.other": "{{count}} паёмҳои шабона",
  "session.overnightDock.sendNow": "Ҳоло фиристед",
  "session.overnightDock.moveToQueue": "Ба навбат интиқол диҳед",
  "session.overnightDock.collapse": "Паёмҳои шабонаро пӯшед",
  "session.overnightDock.expand": "Паёмҳои шабонаро кушоед",
  "session.composer.sendOvernight": "Ба навбати шабона фиристед",
