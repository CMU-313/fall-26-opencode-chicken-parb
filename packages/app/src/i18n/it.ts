export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} messaggio notturno",
  "session.overnightDock.summary.many": "{{count}} di messaggi notturni",
  "session.overnightDock.summary.other": "{{count}} messaggi notturni",
  "session.overnightDock.sendNow": "Invia ora",
  "session.overnightDock.moveToQueue": "Sposta in coda",
  "session.overnightDock.collapse": "Comprimi i messaggi notturni",
  "session.overnightDock.expand": "Espandi i messaggi notturni",
  "session.composer.sendOvernight": "Invia alla coda notturna",
