export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} нощно съобщение",
  "session.overnightDock.summary.other": "{{count}} нощни съобщения",
  "session.overnightDock.sendNow": "Изпратете сега",
  "session.overnightDock.moveToQueue": "Преместване в опашката",
  "session.overnightDock.collapse": "Свиване на нощните съобщения",
  "session.overnightDock.expand": "Разгъване на нощните съобщения",
  "session.composer.sendOvernight": "Изпращане в нощната опашка",
