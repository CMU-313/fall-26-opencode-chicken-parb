export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} nakts ziņa",
  "session.overnightDock.summary.zero": "{{count}} nakts ziņu",
  "session.overnightDock.summary.other": "{{count}} nakts ziņas",
  "session.overnightDock.sendNow": "Sūtīt tagad",
  "session.overnightDock.moveToQueue": "Pārvietot uz rindu",
  "session.overnightDock.collapse": "Sakļaut nakts ziņas",
  "session.overnightDock.expand": "Izvērst nakts ziņas",
  "session.composer.sendOvernight": "Sūtīt uz nakts rindu",
