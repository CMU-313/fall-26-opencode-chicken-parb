export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} ຂໍ້ຄວາມກາງຄືນ",
  "session.overnightDock.summary.other": "{{count}} ຂໍ້ຄວາມກາງຄືນ",
  "session.overnightDock.sendNow": "ສົ່ງດຽວນີ້",
  "session.overnightDock.moveToQueue": "ຍ້າຍໄປຄິວ",
  "session.overnightDock.collapse": "ຫຍໍ້ຂໍ້ຄວາມກາງຄືນ",
  "session.overnightDock.expand": "ຂະຫຍາຍຂໍ້ຄວາມກາງຄືນ",
  "session.composer.sendOvernight": "ສົ່ງໄປຄິວກາງຄືນ",
