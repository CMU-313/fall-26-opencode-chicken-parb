export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} ރޭގަނޑު މެސެޖެކެވެ",
  "session.overnightDock.summary.other": "{{count}} ރޭގަނޑު މެސެޖުތައް",
  "session.overnightDock.sendNow": "މިހާރު ފޮނުއްވާ",
  "session.overnightDock.moveToQueue": "ކިއު އަށް ބަދަލުކުރޭ",
  "session.overnightDock.collapse": "ރޭގަނޑު މެސެޖުތައް ކޮލަޕްސް ކޮށްލާށެވެ",
  "session.overnightDock.expand": "ރޭގަނޑު މެސެޖުތައް ފުޅާކުރުން",
  "session.composer.sendOvernight": "ރޭގަނޑު ކިއު އަށް ފޮނުވާ",
