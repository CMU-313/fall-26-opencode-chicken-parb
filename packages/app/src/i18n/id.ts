export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} pesan semalaman",
  "session.overnightDock.summary.other": "{{count}} pesan semalaman",
  "session.overnightDock.sendNow": "Kirim sekarang",
  "session.overnightDock.moveToQueue": "Pindahkan ke antrean",
  "session.overnightDock.collapse": "Ciutkan pesan semalaman",
  "session.overnightDock.expand": "Bentangkan pesan semalaman",
  "session.composer.sendOvernight": "Kirim ke antrean semalaman",
