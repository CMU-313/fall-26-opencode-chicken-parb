export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}}개의 야간 메시지",
  "session.overnightDock.summary.other": "{{count}}개의 야간 메시지",
  "session.overnightDock.sendNow": "지금 전송",
  "session.overnightDock.moveToQueue": "대기열로 이동",
  "session.overnightDock.collapse": "야간 메시지 접기",
  "session.overnightDock.expand": "야간 메시지 펼치기",
  "session.composer.sendOvernight": "야간 대기열로 보내기",
