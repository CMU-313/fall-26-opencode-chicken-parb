export const dict = {
  ...
  "session.overnightDock.summary.one": "Mesazhi gjatë natës {{count}}",
  "session.overnightDock.summary.other": "{{count}} mesazhe gjatë natës",
  "session.overnightDock.sendNow": "Dërgo tani",
  "session.overnightDock.moveToQueue": "Zhvendos në radhë",
  "session.overnightDock.collapse": "Palos mesazhet e natës",
  "session.overnightDock.expand": "Zgjero mesazhet e natës",
  "session.composer.sendOvernight": "Dërgo te radha e natës",
