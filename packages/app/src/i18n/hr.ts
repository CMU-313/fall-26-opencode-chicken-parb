...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} poruka preko noći",
  "session.overnightDock.summary.few": "{{count}} poruke preko noći",
  "session.overnightDock.summary.other": "{{count}} poruka preko noći",
  "session.overnightDock.sendNow": "Pošalji sada",
  "session.overnightDock.moveToQueue": "Premjesti u red",
  "session.overnightDock.collapse": "Sažmi poruke preko noći",
  "session.overnightDock.expand": "Proširi poruke preko noći",
  "session.composer.sendOvernight": "Pošalji u noćni red",
