export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} gecə mesajı",
  "session.overnightDock.summary.other": "{{count}} gecə mesajı",
  "session.overnightDock.sendNow": "İndi göndər",
  "session.overnightDock.moveToQueue": "Növbəyə köçür",
  "session.overnightDock.collapse": "Gecə mesajlarını yığcamlaşdır",
  "session.overnightDock.expand": "Gecə mesajlarını genişləndir",
  "session.composer.sendOvernight": "Gecə növbəsinə göndər",
