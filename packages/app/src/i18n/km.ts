export const dict = {
  ...
  "session.overnightDock.summary.one": "សារពេលយប់ {{count}}",
  "session.overnightDock.summary.other": "{{count}} សារពេលយប់",
  "session.overnightDock.sendNow": "ផ្ញើឥឡូវនេះ",
  "session.overnightDock.moveToQueue": "ផ្លាស់ទីទៅជួរ",
  "session.overnightDock.collapse": "បង្រួមសារពេលយប់",
  "session.overnightDock.expand": "ពង្រីកសារពេលយប់",
  "session.composer.sendOvernight": "ផ្ញើទៅជួរពេលយប់",
