export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} ข้อความข้ามคืน",
  "session.overnightDock.summary.other": "{{count}} ข้อความข้ามคืน",
  "session.overnightDock.sendNow": "ส่งทันที",
  "session.overnightDock.moveToQueue": "ย้ายไปที่คิว",
  "session.overnightDock.collapse": "ย่อข้อความข้ามคืน",
  "session.overnightDock.expand": "ขยายข้อความข้ามคืน",
  "session.composer.sendOvernight": "ส่งไปยังคิวข้ามคืน",
