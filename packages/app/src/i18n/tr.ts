...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} gece mesajı",
  "session.overnightDock.summary.other": "{{count}} gece mesajı",
  "session.overnightDock.sendNow": "Şimdi gönder",
  "session.overnightDock.moveToQueue": "Kuyruğa taşı",
  "session.overnightDock.collapse": "Gece mesajlarını daralt",
  "session.overnightDock.expand": "Gece mesajlarını genişlet",
  "session.composer.sendOvernight": "Gece kuyruğuna gönder",
