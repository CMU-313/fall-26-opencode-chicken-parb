export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} νυχτερινό μήνυμα",
  "session.overnightDock.summary.other": "{{count}} νυχτερινά μηνύματα",
  "session.overnightDock.sendNow": "Αποστολή τώρα",
  "session.overnightDock.moveToQueue": "Μετακίνηση στην ουρά",
  "session.overnightDock.collapse": "Σύμπτυξη νυχτερινών μηνυμάτων",
  "session.overnightDock.expand": "Ανάπτυξη νυχτερινών μηνυμάτων",
  "session.composer.sendOvernight": "Αποστολή στη νυχτερινή ουρά",
