export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} የምሽት መልእክት",
  "session.overnightDock.summary.other": "{{count}} የምሽት መልዕክቶች",
  "session.overnightDock.sendNow": "አሁን ላክ",
  "session.overnightDock.moveToQueue": "ወደ ወረፋ ውሰድ",
  "session.overnightDock.collapse": "የምሽት መልዕክቶችን ሰብስብ",
  "session.overnightDock.expand": "የምሽት መልዕክቶችን ዘርጋ",
  "session.composer.sendOvernight": "ወደ የምሽት ወረፋ ላክ",
