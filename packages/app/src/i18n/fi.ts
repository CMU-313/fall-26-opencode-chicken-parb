export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} yön yli -viesti",
  "session.overnightDock.summary.other": "{{count}} yön yli -viestiä",
  "session.overnightDock.sendNow": "Lähetä nyt",
  "session.overnightDock.moveToQueue": "Siirrä jonoon",
  "session.overnightDock.collapse": "Kutista yön yli -viestit",
  "session.overnightDock.expand": "Laajenna yön yli -viestit",
  "session.composer.sendOvernight": "Lähetä yöjonoon",
