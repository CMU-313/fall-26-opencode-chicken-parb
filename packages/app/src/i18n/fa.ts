export const dict = {
  ...
  "session.overnightDock.summary.one": "پیام شبانه {{count}}",
  "session.overnightDock.summary.other": "پیام‌های شبانه {{count}}",
  "session.overnightDock.sendNow": "اکنون ارسال کنید",
  "session.overnightDock.moveToQueue": "انتقال به صف",
  "session.overnightDock.collapse": "کوچک کردن پیام‌های شبانه",
  "session.overnightDock.expand": "بزرگ کردن پیام‌های شبانه",
  "session.composer.sendOvernight": "ارسال به صف شبانه",
