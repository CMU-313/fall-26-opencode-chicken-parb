export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} mensaje nocturno",
  "session.overnightDock.summary.many": "{{count}} de mensajes nocturnos",
  "session.overnightDock.summary.other": "{{count}} mensajes nocturnos",
  "session.overnightDock.sendNow": "Enviar ahora",
  "session.overnightDock.moveToQueue": "Mover a la cola",
  "session.overnightDock.collapse": "Contraer mensajes nocturnos",
  "session.overnightDock.expand": "Expandir mensajes nocturnos",
  "session.composer.sendOvernight": "Enviar a la cola nocturna",
