export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} gijeki habar",
  "session.overnightDock.summary.other": "{{count}} gijeki habarlar",
  "session.overnightDock.sendNow": "Indi iber",
  "session.overnightDock.moveToQueue": "Nobata geçir",
  "session.overnightDock.collapse": "Gijeki habarlary ýykmak",
  "session.overnightDock.expand": "Gijeki habarlary giňeltmek",
  "session.composer.sendOvernight": "Gije nobatyna iber",
