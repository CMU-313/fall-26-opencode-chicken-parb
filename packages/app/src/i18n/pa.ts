export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} رات دا پیغام",
  "session.overnightDock.summary.other": "{{count}} رات دے سنیہے",
  "session.overnightDock.sendNow": "ہن بھیجو",
  "session.overnightDock.moveToQueue": "قطار وچ لیجاؤ",
  "session.overnightDock.collapse": "رات والے سنیہے سمیٹو",
  "session.overnightDock.expand": "رات والے سنیہے ودھاؤ",
  "session.composer.sendOvernight": "رات والی قطار وچ بھیجو",
