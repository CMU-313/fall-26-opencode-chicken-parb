export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} sporočilo čez noč",
  "session.overnightDock.summary.two": "{{count}} sporočili čez noč",
  "session.overnightDock.summary.few": "{{count}} sporočila čez noč",
  "session.overnightDock.summary.other": "{{count}} sporočil čez noč",
  "session.overnightDock.sendNow": "Pošlji zdaj",
  "session.overnightDock.moveToQueue": "Premakni v vrsto",
  "session.overnightDock.collapse": "Strni sporočila čez noč",
  "session.overnightDock.expand": "Razširi sporočila čez noč",
  "session.composer.sendOvernight": "Pošlji v nočno vrsto",
