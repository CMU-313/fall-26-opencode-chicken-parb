export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} 件の夜間メッセージ",
  "session.overnightDock.summary.other": "{{count}} 件の夜間メッセージ",
  "session.overnightDock.sendNow": "今すぐ送信",
  "session.overnightDock.moveToQueue": "キューに移動",
  "session.overnightDock.collapse": "夜間メッセージを折りたたむ",
  "session.overnightDock.expand": "夜間メッセージを展開",
  "session.composer.sendOvernight": "夜間キューに送信",
