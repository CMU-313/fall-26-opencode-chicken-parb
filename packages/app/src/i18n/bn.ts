export const dict: Record<string, string> = {
  ...
  "session.overnightDock.summary.one": "{{count}} রাত্রিকালীন বার্তা",
  "session.overnightDock.summary.other": "{{count}} রাত্রিকালীন বার্তা",
  "session.overnightDock.sendNow": "এখন পাঠান",
  "session.overnightDock.moveToQueue": "সারিতে সরান",
  "session.overnightDock.collapse": "রাত্রিকালীন বার্তা সঙ্কুচিত করুন",
  "session.overnightDock.expand": "রাত্রিকালীন বার্তা প্রসারিত করুন",
  "session.composer.sendOvernight": "রাত্রিকালীন সারিতে পাঠান",
