export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} tin nhắn qua đêm",
  "session.overnightDock.summary.other": "{{count}} tin nhắn qua đêm",
  "session.overnightDock.sendNow": "Gửi ngay bây giờ",
  "session.overnightDock.moveToQueue": "Chuyển vào hàng đợi",
  "session.overnightDock.collapse": "Thu gọn tin nhắn qua đêm",
  "session.overnightDock.expand": "Mở rộng tin nhắn qua đêm",
  "session.composer.sendOvernight": "Gửi vào hàng đợi qua đêm",
