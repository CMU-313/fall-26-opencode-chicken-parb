export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} رسالة ليلية",
  "session.overnightDock.summary.zero": "عدد الرسائل الليلية: {{count}}",
  "session.overnightDock.summary.two": "عدد الرسائل الليلية: {{count}}",
  "session.overnightDock.summary.few": "{{count}} رسائل ليلية",
  "session.overnightDock.summary.many": "{{count}} رسالةً ليلية",
  "session.overnightDock.summary.other": "{{count}} رسائل ليلية",
  "session.overnightDock.sendNow": "إرسال الآن",
  "session.overnightDock.moveToQueue": "نقل إلى قائمة الانتظار",
  "session.overnightDock.collapse": "طي الرسائل الليلية",
  "session.overnightDock.expand": "توسيع الرسائل الليلية",
  "session.composer.sendOvernight": "إرسال إلى قائمة الانتظار الليلية",
