export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} nachtbericht",
  "session.overnightDock.summary.other": "{{count}} nachtberichten",
  "session.overnightDock.sendNow": "Verstuur nu",
  "session.overnightDock.moveToQueue": "Verplaats naar wachtrij",
  "session.overnightDock.collapse": "Nachtberichten samenvouwen",
  "session.overnightDock.expand": "Nachtberichten uitvouwen",
  "session.composer.sendOvernight": "Naar de nachtwachtrij sturen",
