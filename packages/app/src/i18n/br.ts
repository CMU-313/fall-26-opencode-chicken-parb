export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} mensagem noturna",
  "session.overnightDock.summary.many": "{{count}} de mensagens noturnas",
  "session.overnightDock.summary.other": "{{count}} mensagens noturnas",
  "session.overnightDock.sendNow": "Enviar agora",
  "session.overnightDock.moveToQueue": "Mover para a fila",
  "session.overnightDock.collapse": "Recolher mensagens noturnas",
  "session.overnightDock.expand": "Expandir mensagens noturnas",
  "session.composer.sendOvernight": "Enviar para a fila noturna",
