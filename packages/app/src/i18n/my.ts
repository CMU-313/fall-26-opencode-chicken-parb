export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} ညအချိန် မက်ဆေ့ဂျ်",
  "session.overnightDock.summary.other": "{{count}} ညအချိန် စာတိုများ",
  "session.overnightDock.sendNow": "ယခု ပို့ပါ။",
  "session.overnightDock.moveToQueue": "တန်းစီရန် ရွှေ့ပါ",
  "session.overnightDock.collapse": "ညအချိန် စာများကို ခေါက်သိမ်းပါ",
  "session.overnightDock.expand": "ညအချိန် စာများကို ချဲ့ပါ",
  "session.composer.sendOvernight": "ညအချိန် တန်းစီရန် ပို့ပါ",
