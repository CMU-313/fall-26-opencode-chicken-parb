export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} natlig besked",
  "session.overnightDock.summary.other": "{{count}} natlige beskeder",
  "session.overnightDock.sendNow": "Send nu",
  "session.overnightDock.moveToQueue": "Flyt til kø",
  "session.overnightDock.collapse": "Skjul natlige beskeder",
  "session.overnightDock.expand": "Udvid natlige beskeder",
  "session.composer.sendOvernight": "Send til natkøen",
