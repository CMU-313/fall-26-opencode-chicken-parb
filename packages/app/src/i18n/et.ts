export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} öine sõnum",
  "session.overnightDock.summary.other": "{{count}} öist sõnumit",
  "session.overnightDock.sendNow": "Saada kohe",
  "session.overnightDock.moveToQueue": "Teisalda järjekorda",
  "session.overnightDock.collapse": "Ahenda öised sõnumid",
  "session.overnightDock.expand": "Laienda öiseid sõnumeid",
  "session.composer.sendOvernight": "Saada öisesse järjekorda",
