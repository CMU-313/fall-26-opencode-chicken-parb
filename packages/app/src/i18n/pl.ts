export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} wiadomość na noc",
  "session.overnightDock.summary.few": "{{count}} wiadomości na noc",
  "session.overnightDock.summary.many": "{{count}} wiadomości na noc",
  "session.overnightDock.summary.other": "{{count}} wiadomości na noc",
  "session.overnightDock.sendNow": "Wyślij teraz",
  "session.overnightDock.moveToQueue": "Przenieś do kolejki",
  "session.overnightDock.collapse": "Zwiń wiadomości na noc",
  "session.overnightDock.expand": "Rozwiń wiadomości na noc",
  "session.composer.sendOvernight": "Wyślij do kolejki nocnej",
