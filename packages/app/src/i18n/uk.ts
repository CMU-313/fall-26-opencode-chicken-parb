export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} повідомлення в нічній черзі",
  "session.overnightDock.summary.few": "{{count}} повідомлення в нічній черзі",
  "session.overnightDock.summary.many": "{{count}} повідомлень у нічній черзі",
  "session.overnightDock.summary.other": "{{count}} повідомлень у нічній черзі",
  "session.overnightDock.sendNow": "Надіслати зараз",
  "session.overnightDock.moveToQueue": "Перемістити в чергу",
  "session.overnightDock.collapse": "Згорнути нічні повідомлення",
  "session.overnightDock.expand": "Розгорнути нічні повідомлення",
  "session.composer.sendOvernight": "Надіслати в нічну чергу",
