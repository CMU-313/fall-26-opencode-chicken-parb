export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} сообщение в ночной очереди",
  "session.overnightDock.summary.few": "{{count}} сообщения в ночной очереди",
  "session.overnightDock.summary.many": "{{count}} сообщений в ночной очереди",
  "session.overnightDock.summary.other": "Сообщений в ночной очереди: {{count}}",
  "session.overnightDock.sendNow": "Отправить сейчас",
  "session.overnightDock.moveToQueue": "Переместить в очередь",
  "session.overnightDock.collapse": "Свернуть ночные сообщения",
  "session.overnightDock.expand": "Развернуть ночные сообщения",
  "session.composer.sendOvernight": "Отправить в ночную очередь",
