export const dict: Record<string, string> = {
  ...
  "session.overnightDock.summary.one": "{{count}} රාත්‍රී පණිවිඩය",
  "session.overnightDock.summary.other": "{{count}} රාත්‍රී පණිවිඩ",
  "session.overnightDock.sendNow": "දැන් එවන්න",
  "session.overnightDock.moveToQueue": "පෝලිමට ගෙන යන්න",
  "session.overnightDock.collapse": "රාත්‍රී පණිවිඩ හකුළන්න",
  "session.overnightDock.expand": "රාත්‍රී පණිවිඩ දිග හරින්න",
  "session.composer.sendOvernight": "රාත්‍රී පෝලිමට යවන්න",
