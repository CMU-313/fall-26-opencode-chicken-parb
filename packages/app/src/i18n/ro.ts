export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} mesaj de noapte",
  "session.overnightDock.summary.few": "{{count}} mesaje de noapte",
  "session.overnightDock.summary.other": "{{count}} mesaje de noapte",
  "session.overnightDock.sendNow": "Trimite acum",
  "session.overnightDock.moveToQueue": "Mută în coadă",
  "session.overnightDock.collapse": "Restrânge mesajele de noapte",
  "session.overnightDock.expand": "Extinde mesajele de noapte",
  "session.composer.sendOvernight": "Trimite în coada de noapte",
