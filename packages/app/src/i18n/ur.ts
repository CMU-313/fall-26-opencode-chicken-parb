export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} رات کا پیغام",
  "session.overnightDock.summary.other": "{{count}} رات کے پیغامات",
  "session.overnightDock.sendNow": "ابھی بھیجیں۔",
  "session.overnightDock.moveToQueue": "قطار میں منتقل کریں",
  "session.overnightDock.collapse": "رات کے پیغامات سکیڑیں",
  "session.overnightDock.expand": "رات کے پیغامات پھیلائیں",
  "session.composer.sendOvernight": "رات کی قطار میں بھیجیں",
