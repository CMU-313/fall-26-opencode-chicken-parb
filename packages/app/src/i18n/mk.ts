export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} ноќна порака",
  "session.overnightDock.summary.other": "{{count}} ноќни пораки",
  "session.overnightDock.sendNow": "Испрати сега",
  "session.overnightDock.moveToQueue": "Премести во редица",
  "session.overnightDock.collapse": "Собери ги ноќните пораки",
  "session.overnightDock.expand": "Прошири ги ноќните пораки",
  "session.composer.sendOvernight": "Испрати во ноќната редица",
