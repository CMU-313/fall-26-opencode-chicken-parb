...
export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} Nachricht über Nacht",
  "session.overnightDock.summary.other": "{{count}} Nachrichten über Nacht",
  "session.overnightDock.sendNow": "Jetzt senden",
  "session.overnightDock.moveToQueue": "In die Warteschlange verschieben",
  "session.overnightDock.collapse": "Nachrichten über Nacht einklappen",
  "session.overnightDock.expand": "Nachrichten über Nacht ausklappen",
  "session.composer.sendOvernight": "An die Nachtwarteschlange senden",
