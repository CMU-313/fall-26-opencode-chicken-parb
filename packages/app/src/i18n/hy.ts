export const dict = {
  ...
  "session.overnightDock.summary.one": "{{count}} գիշերային հաղորդագրություն",
  "session.overnightDock.summary.other": "{{count}} գիշերային հաղորդագրություններ",
  "session.overnightDock.sendNow": "Ուղարկել հիմա",
  "session.overnightDock.moveToQueue": "Տեղափոխել հերթ",
  "session.overnightDock.collapse": "Ծալել գիշերային հաղորդագրությունները",
  "session.overnightDock.expand": "Ընդարձակել գիշերային հաղորդագրությունները",
  "session.composer.sendOvernight": "Ուղարկել գիշերային հերթ",
